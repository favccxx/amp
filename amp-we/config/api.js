// 以下是业务服务器API地址
// 本机开发时使用
var WxApiRoot = 'http://localhost:8089/wx/api/';
// 局域网测试使用
...
module.exports = {
  ...
  CatalogList: WxApiRoot + 'category/index', //分类目录全部分类数据接口
  CatalogCurrent: WxApiRoot + 'category/current', //分类目录当前分类数据接口
  ...
  GoodsNew: WxApiRoot + 'product/new', //新品
  GoodsHot: WxApiRoot + 'product/hot', //热门
