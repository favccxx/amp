<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('category.categoryCode')" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.categoryCode }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('category.categoryName')" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.categoryName }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('category.status')" width="180px" align="center">
        <template slot-scope="scope">
          <el-tag :type="scope.row.status | statusFilter">{{ scope.row.status | statusShowFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column :label="$t('category.updateTime')" width="150px" align="center">
        <template slot-scope="scope">
