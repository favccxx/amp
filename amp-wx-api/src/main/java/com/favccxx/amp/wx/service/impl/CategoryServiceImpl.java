...
import com.favccxx.amp.wx.constants.CategoryStatus;
...
public class CategoryServiceImpl extends BaseServiceImpl<CategoryRepository, AmpCategory> implements CategoryService {
	...
	@Override
	public List<AmpCategory> queryChannel() {
	...
	@Override
	public List<AmpCategory> listByParent(long parentId) {
		return repository.findByParentIdAndStatus(parentId, CategoryStatus.ENABLE.value());
	}
